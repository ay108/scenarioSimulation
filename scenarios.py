...
# Sidebar options
scenarios = ['Baseline Model', 'Generation Doubled, met with Coal', 'Natural Gas Prices Doubled', 'Wind Generation Doubled', 'Mines Close', 'Elon Musk Opens a Data Center']
...
if scenario == 'Baseline Model':
    st.write("Baseline Model (No Scenario)")
...
elif scenario == 'Generation Doubled, met with Coal':
    st.write("In this scenario, the generation is doubled and met with coal.")
    st.write("The model predicts the electricity prices for the next 12 months.")
    # Predict the electricity prices for the next 12 months
    model = sarimax_model
    ...
    st.write("In this scenario, the natural gas prices are doubled.")
    st.write("The model predicts the electricity prices for the next 12 months.")
    # Predict the electricity prices for the next 12 months
    model = sarimax_model
...
elif scenario == 'Generation Doubled with Wind Generation':
    st.write("In this scenario, the natural gas prices are doubled.")
    st.write("The model predicts the electricity prices for the next 12 months.")
    # Predict the electricity prices for the next 12 months
    model = sarimax_model
    ...
    st.write("In this scenario, the mines have closed.")
